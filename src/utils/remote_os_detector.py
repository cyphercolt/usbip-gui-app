...
class RemoteOSDetector:
    ...
    @staticmethod
    def detect_remote_os(ip: str, username: str, password: str, accept_fingerprint: bool = True) -> Tuple[Optional[str], bool]:
        """
        ...
        try:
            ...
            for cmd in commands_to_try:
                try:
                    ...
                    if output and ('usbipd' in output.lower() or 'version' in output.lower()):
                        usbipd_found = True
                        break
                except:
                    continue
    ...
    @staticmethod
    def get_remote_usbip_bind_command(os_type: str, busid: str, has_usbipd: bool = False) -> str:
        """
    ...
    @staticmethod
    def get_remote_usbip_unbind_command(os_type: str, busid: str, has_usbipd: bool = False) -> str:
        """
        ...
        """
        if os_type == 'windows' and has_usbipd:
            return f'usbipd unbind --busid {SecurityValidator.sanitize_for_shell(busid)}'
        else:
            # Linux, macOS, or Windows without usbipd - requires sudo
