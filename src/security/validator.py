...
class SecureCommandBuilder:
    ...
    @staticmethod
    def build_usbip_bind_command(
        busid: str, password: str, remote_execution: bool = False
    ) -> Optional[str]:
    ...
    @staticmethod
    def build_usbip_unbind_command(
        busid: str, password: str, remote_execution: bool = False
    ) -> Optional[str]:
    ...
    def build_systemctl_command(
        action: str, service: str, password: str, remote_execution: bool = False
    ) -> Optional[str]:
    ...
    @staticmethod
    def build_modprobe_command(
        modules: str, password: str, remote_execution: bool = False
    ) -> Optional[str]:
        ...
        safe_modules = " ".join(
            SecurityValidator.sanitize_for_shell(module) for module in module_list
        )
